...
variant_for_slice()
{
  ...
  "AgoraContentInspectExtension.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "AgoraDav1d.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "AgoraDrmLoaderExtension.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "AgoraPvcExtension.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  ...
  "Agoraffmpeg.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  "av1.xcframework/macos-arm64_x86_64")
    echo ""
    ;;
  esac
}
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_Special_macOS/AgoraDav1d.xcframework" "AgoraRtcEngine_Special_macOS" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_Special_macOS/AgoraDrmLoaderExtension.xcframework" "AgoraRtcEngine_Special_macOS" "framework" "macos-arm64_x86_64"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_Special_macOS/AgoraPvcExtension.xcframework" "AgoraRtcEngine_Special_macOS" "framework" "macos-arm64_x86_64"
...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_Special_macOS/av1.xcframework" "AgoraRtcEngine_Special_macOS" "framework" "macos-arm64_x86_64"

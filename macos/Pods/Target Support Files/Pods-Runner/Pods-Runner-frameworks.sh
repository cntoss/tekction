...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/AgoraIrisEventFlutter_macOS/iris_event_handler.framework"
  install_framework "${PODS_ROOT}/AgoraIrisRTC_macOS/AgoraRtcWrapper.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/agora_rtc_engine/agora_rtc_engine.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iris_event/iris_event.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AgoraRtcEngine_Special_macOS/AgoraDav1d.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AgoraRtcEngine_Special_macOS/AgoraDrmLoaderExtension.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AgoraRtcEngine_Special_macOS/AgoraPvcExtension.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/AgoraRtcEngine_Special_macOS/av1.framework"
fi
